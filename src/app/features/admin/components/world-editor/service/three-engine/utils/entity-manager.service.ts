...
const CELESTIAL_MESH_PREFIX = 'CelestialObjects_'; // <-- ¡NUEVA CONSTANTE!
...
export class EntityManagerService {
  ...
  public publishSceneEntities(): void {
    ...
    this.scene.children.forEach(object => {
      ...
      // Procesar TODOS los meshes de objetos celestes
  ...
  // ... (El resto de métodos como setGroupBrightness, clearScene, etc. se han adaptado para usar el prefijo) ...
