...
export class ControlsManagerService implements OnDestroy {
  ...
  public init(camera: THREE.PerspectiveCamera, domElement: HTMLElement, scene: THREE.Scene, focusPivot: THREE.Object3D): void {
    ...
    // ✅ CORRECCIÓN: Se llama a la función sin el parámetro `scene`
  ...
  // =================================================================
  // --- SECCIÓN: Creación y Configuración de Controles ---
  // =================================================================
  ...
  // ✅ CORRECCIÓN: Esta función ha sido restaurada a su versión original y correcta.
  private createTransformControls(camera: THREE.PerspectiveCamera, domElement: HTMLElement): void {
    ...
    // La línea `scene.add(this.transformControls)` que causaba el error ha sido eliminada.
  }

  // =================================================================
  // --- SECCIÓN: API Pública: Gestión de Controles y Herramientas ---
  // =================================================================
  ...
  // =================================================================
  // --- SECCIÓN: Bucle de Actualización y Lógica de Movimiento ---
  // =================================================================
  ...
  // =================================================================
  // --- SECCIÓN: Gestión de Eventos y Callbacks ---
  // =================================================================
  ...
  private syncPivotToControlsTarget = (): void => {
    if (this.focusPivot) { this.focusPivot.position.copy(this.orbitControls.target); }
  };
  ...
  // =================================================================
  // --- SECCIÓN: Métodos de Acceso (Getters) ---
  // =================================================================
