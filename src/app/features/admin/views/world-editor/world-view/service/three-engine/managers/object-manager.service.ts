...
export class ObjectManagerService {
  ...
  private createCamera(scene: THREE.Scene, objData: SceneObjectResponse): THREE.PerspectiveCamera {
    ...
    // ====================================================================
    // ✨ LÓGICA MEJORADA: Se usan valores por defecto apropiados para escalas astronómicas.
    // ====================================================================
    const camera = new THREE.PerspectiveCamera(
        props['fov'] ?? 50, 
        16 / 9, 
        props['near'] ?? 1000,     // Aumentado desde 0.1
        props['far'] ?? 5e15       // Aumentado desde 1000
    );
